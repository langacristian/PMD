...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    ChangeItemNumber changeNumberItemsListener;

    public CartListAdapter(ArrayList<FoodDomain> listFoodSelected, Context context, ChangeItemNumber changeNumberItemsListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalEachItem.setText("$" + Math.round((listFoodSelected.get(position).getCartNr() * listFoodSelected.get(position).getFee())));
        holder.num.setText(String.valueOf(listFoodSelected.get(position).getCartNr()));
