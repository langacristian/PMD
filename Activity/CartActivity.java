...
public class CartActivity extends AppCompatActivity {
    ...
    private void bottomNavigation() {
        LinearLayout homeBtn1 = findViewById(R.id.homeBtn1);
        LinearLayout cartBtn1 = findViewById(R.id.cartBtn1);
        ...
        cartBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void initList() {
        ...
        adapter = new CartListAdapter(managementCart.getListCart(), this, new ChangeItemNumber() {
            @Override
            public void changed() {
                calculateCard();
            }
